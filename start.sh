...
sleep 2
screen -S jupyter-notebook -dm sudo jupyter-notebook --ip 0.0.0.0 --port ${JUPYTER_NOTEBOOK_PORT} --allow-root --NotebookApp.token ${PASSWORD} --NotebookApp.password ${PASSWORD}
tail -f /dev/null
