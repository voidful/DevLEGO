export CODE_SERVER_VERSION="4.95.2"                 # https://github.com/cdr/code-server/releases
export TTYD_VERSION="1.7.7"                         # https://github.com/tsl0922/ttyd/releases
...
export GO_VERSION="1.22.1"                          # https://golang.org/dl/
export TINYGO_VERSION="0.34.0"                      # https://github.com/tinygo-org/tinygo/releases
export TINYGO_EXTENSION_VERSION="0.5.0"             # https://github.com/tinygo-org/vscode-tinygo/releases
export JAVA_JUPYTER_VERSION="1.3.0"                 # https://github.com/SpencerPark/IJava/releases
export JULIA_MAJOR_VERSION="1.11"                   # https://julialang.org/downloads/#current_stable_release
export JULIA_MINOR_VERSION="1"                      # https://julialang.org/downloads/#current_stable_release
export OCTAVE_HACKING_EXTENSION_VERSION="0.2.14"    # https://github.com/apjanke/vscode-octave-hacking/releases
...
export K9S_VERSION="0.32.6"                         # https://github.com/derailed/k9s/releases
export AERC_VERSION="latest"                        # https://github.com/pojntfx/aerc-binaries/releases
export GRPCURL_VERSION="1.9.1"                      # https://github.com/fullstorydev/grpcurl/releases
...
export POWERSHELL_EXTENSION_VERSION="2024.4.0"      # https://github.com/PowerShell/vscode-powershell/releases
